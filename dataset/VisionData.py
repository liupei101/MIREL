"""
Copied from https://pytorch.org/vision/0.15/_modules/torchvision/datasets/dtd.html#DTD
"""
import os
import pathlib
...
class DTD(VisionDataset):
    ...
    def _download(self) -> None:
        if self._check_exists():
            return
        download_and_extract_archive(self._URL, str(self._base_folder), filename=self._FILE_NAME, md5=self._MD5)